...
def writeRenameEnclosures(nr,filenamepart):		
	for frame in variablesAll:
		...
		outfile.write('\n')
		outfile.write('    - name: Rename Enclosure Main-1\n')
		...
		outfile.write('          newName: "'+frame["letter"]+'-Main1"\n')
		outfile.write('\n')
		outfile.write('    - name: Rename Enclosure Main-2\n')
		outfile.write('      oneview_enclosure:\n')
		outfile.write('        config: "{{ config }}"\n')
		outfile.write('        state: present\n')
		outfile.write('        validate_etag: False\n')
		...
		outfile.write('          newName: "'+frame["letter"]+'-Main2"\n')
		outfile.write('\n')
		outfile.write('    - name: Rename Enclosure Subordinate\n')
		outfile.write('      oneview_enclosure:\n')
		outfile.write('        config: "{{ config }}"\n')
		outfile.write('        state: present\n')
		outfile.write('        validate_etag: False\n')
		...
		outfile.write('          newName: "'+frame["letter"]+'-Subordinate"\n')
		outfile.write('\n')
		#END
		outfile.close()
...
def writeOSdeploymentServer(nr,filenamepart):
	for frame in variablesAll:
		...
		outfile.write('          applianceName: "'+frame["letter"]+'-Main2, appliance 2"'+"\n")
...
def writeLogicalEnclosure(nr,filenamepart):
	for frame in variablesAll:
		...
		outfile.write("\n")
		outfile.write('  - name: Gather information about Enclosure '+frame["letter"]+'-Main1'+"\n")
		outfile.write('    oneview_enclosure_info:'+"\n")
		outfile.write('      config: "{{ config }}"'+"\n")
		outfile.write('      name: "'+frame["letter"]+'-Main1"'+"\n")
		outfile.write('    no_log: true'+"\n")
		outfile.write('    delegate_to: localhost'+"\n")
		outfile.write('    register: result'+"\n")
		outfile.write("\n")
		outfile.write('  - set_fact:'+"\n")
		outfile.write('      var_main1uri="{{ result.enclosures[0].uri }}"'+"\n")
		outfile.write("\n")
		outfile.write('  - name: Gather information about Enclosure '+frame["letter"]+'-Main2'+"\n")
		outfile.write('    oneview_enclosure_info:'+"\n")
		outfile.write('      config: "{{ config }}"'+"\n")
		outfile.write('      name: "'+frame["letter"]+'-Main2"'+"\n")
		outfile.write('    no_log: true'+"\n")
		outfile.write('    delegate_to: localhost'+"\n")
		outfile.write('    register: result'+"\n")
		outfile.write("\n")
		outfile.write('  - set_fact:'+"\n")
		outfile.write('      var_main2uri="{{ result.enclosures[0].uri }}"'+"\n")
		outfile.write("\n")
		outfile.write('  - name: Gather information about Enclosure '+frame["letter"]+'-Subordinate'+"\n")
		outfile.write('    oneview_enclosure_info:'+"\n")
		outfile.write('      config: "{{ config }}"'+"\n")
		outfile.write('      name: "'+frame["letter"]+'-Subordinate"'+"\n")
		outfile.write('    no_log: true'+"\n")
		outfile.write('    delegate_to: localhost'+"\n")
		outfile.write('    register: result'+"\n")
		outfile.write("\n")
		outfile.write('  - set_fact:'+"\n")
		outfile.write('      var_subordinateuri="{{ result.enclosures[0].uri }}"'+"\n")
		outfile.write("\n")
		...
		outfile.write('          - "{{ var_main1uri }}"'+"\n")
		outfile.write('          - "{{ var_main2uri }}"'+"\n")
		outfile.write('          - "{{ var_subordinateuri }}"'+"\n")
...
#Mainplaybook (one per zone)
def writeMainPlaybook():
	for frame in variablesAll:
